...
{clicked && titles.length > 0 ? <TitleSelection titles={titles} /> : (        <div className="flex flex-col md:flex-row justify-center items-start md:items-center h-screen bg-blue-100">
                ...
                {showInputs && (
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 mb-4">
                            <label className="block text-gray-700 font-bold mb-2" htmlFor="project-name">
                                Project Name
                            </label>
                            <input
