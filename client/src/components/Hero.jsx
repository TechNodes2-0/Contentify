          ...
          <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="max-w-screen-md mb-8 lg:mb-16">
              <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                Designed for competitive teams like yours
              </h2>
              <p class="text-gray-500 sm:text-xl dark:text-gray-400">
              Unleash the power of AI for seamless content management, empowering education and driving positive change for a sustainable future with Contentify.
"Harness the potential of AI to revolutionize content management, shape educational experiences, and combat climate change for a better tomorrow with Contentify.
              </p>
            </div>
